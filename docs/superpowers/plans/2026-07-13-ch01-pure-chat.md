# EikoHelp Ch01 纯对话客服 Implementation Plan
...
```bash
cd /Users/codemelo/eikohelp-all/eikohelp
uv init --python 3.12 --name eikohelp --bare
...
app = FastAPI(title="EikoHelp", version="0.1.0")
